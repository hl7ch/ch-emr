...
* section[sectionResuscitation].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'><p>Reanimationsstatus:</p><ul><li>For attempted cardiopulmonary resuscitation</li></ul></div>"
